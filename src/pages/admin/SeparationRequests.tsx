...
const SeparationRequests = () => {
  ...
  return (
    <AdminLayout
      ...
      subtitle={`${pgSeps.length} request${pgSeps.length !== 1 ? 's' : ''}`}
      breadcrumbs={[
      ...
      <div className="glass-card rounded-xl overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            ...
            <TableBody>
              {pgSeps.length === 0 ? (
                <TableRow><TableCell colSpan={8} className="text-center py-8 text-muted-foreground">No separation requests</TableCell></TableRow>
              ) : (
                pgSeps.map(s => (
                  <TableRow key={s.id}>
